...
export const blockchainConfig = {
  ...
  contracts: {
    academicNFT: {
      ...
      address: '0x2d00C3501bc0F7C74Ba731C5e927C69ee4b6Ffd0',
      // chainId: sepolia.id
    ...
    market: {
      ...
      address: '0x59816B9Db8Adb4d786587B14906ae8D512a734c6',
      // chainId: sepolia.id
      chainId: localhost.id,
      abi: MARKET_ABI
    },
    accessToken: {
      address: '0x325eB5a12ad15bb99f14F212Ad7B93A1B1B508fe',
      // chainId: sepolia.id
      chainId: localhost.id,
